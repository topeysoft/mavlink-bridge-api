...
export class ErrorHandler {
   ...
   */
  public handleError(error: any, context: ErrorContext): void {
   ...
   */
  public handleConnectionError(error: any, context: ErrorContext): void {
   ...
   */
  public handleValidationError(error: any, context: ErrorContext): void {
  ...
  private getFriendlyErrorMessage(error: any, context: ErrorContext): string {
  ...
  private extractTechnicalDetails(error: any): any {
    const details: any = {};
  ...
  private shouldRetry(error: any, retryableErrors?: string[]): boolean {
