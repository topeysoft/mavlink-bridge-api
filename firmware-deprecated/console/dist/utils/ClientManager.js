...
import ora from 'ora';
import { createClient, discoverMAVLinkBridgeDevices } from '@mavlinkbridge/api-client';
export class ClientManager {
    context = null;
    setContext(context) {
        this.context = context;
    }
    async discoverDevices(options = {}, onProgress) {
     ...
     */
    async discoverDeviceUrls(timeout = 5000) {
