...
const stats = computed(() => [
  { label: 'Active Missions', value: '2', icon: 'mission', color: 'var(--primary-green)', route: null },
  { label: 'Coverage Today', value: '2.4 acres', icon: 'map', color: 'var(--sky-blue)', route: null },
  { label: 'Battery Level', value: `${batteryLevel.value}%`, icon: 'battery', color: batteryColor.value, route: 'battery' },
  { label: 'System Status', value: 'Healthy', icon: 'health', color: 'var(--status-success)', route: null }
])
